  ...
  onStart: async function({ api, event, args }) {
    ...
    try {
      ...
      if (!np) {
        ...
        return api.sendMessage('💬 chat gpt is her to answer your question.', event.threadID, event.messageID);
      ...
      const cliff = await new Promise(resolve => {
        ...
        api.sendMessage('[🖕🏻] 𝐩𝐚𝐠 𝐡𝐮𝐥𝐚𝐭....', event.threadID, (err, info1) => {
      ...
      gpt({
        ...
        messages: [
...

          {
            ...
            content: `💬 𝐡𝐢 𝐚𝐤𝐨 𝐧𝐠𝐚 𝐩𝐚𝐥𝐚 𝐦𝐚𝐫𝐤 𝐧𝐚 𝐩𝐨𝐠𝐢 𝐚𝐚𝐧𝐠𝐚𝐥 𝐤𝐚 𝐣𝐨𝐤𝐞 𝐭𝐚𝐧𝐨𝐧𝐠 𝐤𝐚𝐧𝐚 𝐥𝐨𝐯𝐞?`
